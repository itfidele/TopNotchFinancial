            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = mysqli_query($connection, "SELECT * FROM  properties ") or die(mysqli_error($connection));
                                        $no = 0;
                        ...
                        <a href="addProperty" class="btn btn-primary btn-rounded btn-floated"><i data-feather="plus-circle"></i> Add Property</a>
                    </div>
                </div>
            </div>
